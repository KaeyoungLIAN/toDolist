  ...
  return (
    <div id="titlebar" data-tauri-drag-region>
      <div id="title-left">
        ...
        <button className={"title-btn search-toggle" + (showSearch ? " active" : "")} id="search-toggle-btn" title="Search" onClick={(e) => { e.stopPropagation(); onToggleSearch(); }}>
      ...
      <div id="title-controls">
        ...
        <button className={"title-btn" + (isPinned ? " active" : "")} id="pin-btn" title="Always on top" onClick={(e) => { e.stopPropagation(); handlePin(); }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
