  ...
  return (
    <div id="titlebar">
      <div id="title-left">
        ...
        <button className={"title-btn search-toggle" + (showSearch ? " active" : "")} id="search-toggle-btn" title="Search" onPointerDown={(e) => { e.stopPropagation(); onToggleSearch(); }}>
      ...
      <div id="title-controls">
        <button className="title-btn" id="settings-btn" title="Settings" onPointerDown={(e) => { e.stopPropagation(); onOpenSettings(); }}>
        ...
        <button className="title-btn close-btn" id="close-btn" title="Hide to tray" onPointerDown={(e) => { e.stopPropagation(); handleClose(); }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
