    ...
    <>
      <div id="titlebar" data-tauri-drag-region>
        ...
        <div id="title-controls">
          ...
          <button className={"title-btn collapse-btn" + (collapsed ? " active" : "")} id="collapse-btn" title={lang === "zh" ? (collapsed ? "展开" : "折叠") : (collapsed ? "Expand" : "Collapse")} onClick={onToggleCollapse}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              {collapsed ? (
          ...
          <button className="title-btn" id="min-btn" title={t(lang, "minimize")} onClick={handleMin}>
